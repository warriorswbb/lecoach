from sqlalchemy import Column, Integer, String, Date, Boolean, Float, Text, ForeignKey, Index
...
class Game(Base):
    ...
    team_one = Column(Integer, ForeignKey("teams.team_id"))
    team_two = Column(Integer, ForeignKey("teams.team_id"))
    ...
    team_one_stats_id = Column(Integer, ForeignKey("team_game_stats.id"))
    team_two_stats_id = Column(Integer, ForeignKey("team_game_stats.id"))
...
class PlayerGameStats(Base):
    ...
    fg3_percent = Column(Float, name="3pt_percent")
    fg2_percent = Column(Float, name="2pt_percent")
...
class TeamGameStats(Base):
    ...
    steal = Column(Integer, nullable=False)
    points = Column(Integer, nullable=False)
    possessions = Column(Float(53))
    offrtg = Column(Float(53))
    defrtg = Column(Float(53))
    pace = Column(Float(53))
...
class TeamSeasonStats(Base):
    ...
    offrtg = Column(Float(53))
    defrtg = Column(Float(53))
    offrtg_adj = Column(Float(53))
    defrtg_adj = Column(Float(53))
    pace = Column(Float(53))
    poss_per_game = Column(Float)
